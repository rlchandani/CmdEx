...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    static let appStore = Store(initialState: AppFeature.State()) { AppFeature() }
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Wire live implementations are defined in their DependencyKey conformances
        // in ShortcutBarCore. App-level singletons (ToastWindow, ScreenshotWatcher)
        // are accessed directly where needed since they require AppKit.
